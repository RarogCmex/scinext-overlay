...
CKT_CI="4f54fa30583704f34da2ac50372d524cae6bad7d"
CUTLASS_CI="e9627ce55b42fd2599f58cd4396da9380954def0"
FLASH_CI="979702c87a8713a8e0a5e9fee122b90d2ef13be5"
KEYWORDS="~amd64"
...
RDEPEND="
	|| (
	=sci-ml/pytorch-2.7*[cuda,${PYTHON_SINGLE_USEDEP}]
	sci-ml/caffe2[cuda]
	)
	$(python_gen_cond_dep '
