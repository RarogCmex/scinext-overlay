...
PATCHES=( "${FILESDIR}/torchaudio-2.5.0-fix-cuda-12.5.patch")

DEPEND="
	ffmpeg? ( <media-video/ffmpeg-7:= )
"
#TODO: ffmpeg-7 will probably be supported in next release
RDEPEND="
	${DEPEND}
	>=sci-libs/pytorch-2.5.1-r50[cuda?,rocm?,openmp?,${PYTHON_SINGLE_USEDEP}]
"
BDEPEND="
	test? (
		$(python_gen_cond_dep '
...
src_configure() {
	...
	export BUILD_SOX=0 #TODO: support for media-sound/sox
